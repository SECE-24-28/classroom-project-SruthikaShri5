...
const RechargePlans = () => {
  ...
  const mockPlans = [
    { id: 1, type: 'prepaid', price: 99, validity: '14 days', data: '1GB/day', description: '50 SMS/day' },
    { id: 2, type: 'prepaid', price: 199, validity: '28 days', data: '1.5GB/day', description: '100 SMS/day' },
    { id: 3, type: 'prepaid', price: 299, validity: '56 days', data: '2GB/day', description: 'Unlimited calls' },
    { id: 4, type: 'prepaid', price: 399, validity: '84 days', data: '2.5GB/day', description: 'Unlimited calls + SMS' },
    { id: 5, type: 'prepaid', price: 599, validity: '365 days', data: '1.5GB/day', description: 'Annual plan' },
    { id: 6, type: 'postpaid', price: 499, validity: '30 days', data: '25GB', description: 'Unlimited calls + SMS' },
    { id: 7, type: 'postpaid', price: 699, validity: '30 days', data: '50GB', description: 'Premium benefits' },
    { id: 8, type: 'postpaid', price: 999, validity: '30 days', data: '100GB', description: 'Enterprise plan' }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-gray-50 to-slate-100 py-8">
      ...
      {showModal && selectedPlan && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="card p-8 max-w-md mx-4 animate-scale-in">
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <span className="font-bold text-gray-900">{selectedPlan.type}</span>
              </div>
              <div className="flex justify-between p-3 bg-gray-50 rounded-lg">
              ...
              <div className="flex justify-between p-3 bg-gray-50 rounded-lg">
                <span className="font-medium font-opensans text-gray-700">Data</span>
                <span className="font-bold text-gray-900">{selectedPlan.data}</span>
              </div>
              <div className="p-3 bg-gray-50 rounded-lg">
                <span className="font-medium font-opensans text-gray-700">Benefits</span>
                <p className="font-bold text-gray-900 mt-1">{selectedPlan.description}</p>
              </div>
            </div>
