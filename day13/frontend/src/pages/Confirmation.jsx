...
const Confirmation = () => {
  ...
  useEffect(() => {
    const processTransaction = async () => {
      ...
      console.log('rechargeData:', localStorage.getItem('rechargeData'));
      console.log('selectedPlan:', localStorage.getItem('selectedPlan'));
      console.log('paymentMethod:', localStorage.getItem('paymentMethod'));
      ...
      if (typeof paymentMethodData === 'object' && paymentMethodData.method) {
        const methodMap = {
        ...
        paymentDisplay = paymentMethodData;
      }
      ...
      const txn = {
        ...
        date: currentDate,
        time: currentTime,
        mobile: rechargeData.mobile || JSON.parse(localStorage.getItem('user') || '{}').mobile || JSON.parse(localStorage.getItem('user') || '{}').phone || 'Not Available',
        operator: rechargeData.operator || 'Not Available',
        planName: selectedPlan.planName || `₹${selectedPlan.price || 0} Plan`,
        planType: selectedPlan.type || 'Not Available',
        plan: `₹${selectedPlan.price || 0} - ${selectedPlan.validity || 'N/A'}`,
      ...
      console.log('Payment Method:', JSON.stringify(paymentMethodData, null, 2));
      ...
      // Clear recharge data after transaction
