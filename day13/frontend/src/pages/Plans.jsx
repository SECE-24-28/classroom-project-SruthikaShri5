    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-gray-50 to-slate-100 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-xl font-opensans text-gray-600 mb-6">
        ...
        {loading ? (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {plans.map((plan, index) => (
              <div key={plan.id} className={`card p-6 animate-scale-in hover:shadow-2xl transform hover:-translate-y-2 ${plan.type === 'popular' ? 'border-2 border-emerald-400 ring-2 ring-emerald-200' : ''}`} style={{animationDelay: `${index * 0.1}s`}}>
                {plan.type === 'popular' && (
